...
{
    private static readonly Color UnlockedColor = new Color32(74, 144, 226, 255);
    private static readonly Color LockedColor = new Color32(52, 73, 94, 255);
    ...
    private void CreateCell(int index)
    {
        ...
        bg.color = unlocked ? UnlockedColor : LockedColor;

        var button = cellGo.AddComponent<Button>();
        button.targetGraphic = bg;
        var group = cellGo.AddComponent<CanvasGroup>();
